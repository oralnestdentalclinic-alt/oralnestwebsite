          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-lg text-foreground leading-relaxed pl-8">
                The team at OralNest is amazing! The clinic is so modern and
                clean. My smile has never looked better!
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <div>
                <p className="font-semibold text-foreground">Anjali Chatterjee</p>
